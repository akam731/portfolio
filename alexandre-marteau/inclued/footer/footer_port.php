...
<footer class="section fade"> 
	...
	<div class="link">
		...
		<a href="../?target=link_portfolio" class="about_contact_logo_portfolio" title="<?php lang("Voir mes projets", "See my projects"); ?>"><i class="fa-solid fa-briefcase"></i></a>
